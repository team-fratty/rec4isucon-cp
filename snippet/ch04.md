...
```sh
cd
git clone https://github.com/team-fratty/rec4isucon-cp.git code-nglog
...
```sh
cd
git clone https://github.com/team-fratty/rec4isucon-cp.git code-measure
...
```sh
cd
git clone https://github.com/team-fratty/rec4isucon-cp.git code-slow
